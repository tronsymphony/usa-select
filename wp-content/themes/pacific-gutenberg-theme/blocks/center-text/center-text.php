...
<section id="<?php echo esc_attr($id); ?>" class="<?php echo esc_attr($className); echo ' styling-' . get_field('light_style'); ?> border_<?php the_field('remove_border_top'); ?>"
    style="--padding-top: <?= ($block_styling['padding-top']) ? $block_styling['padding-top'] . 'px' : '20px' ?>;
    ...
    <div class="container">
        <div class="content">
            ...
            <?php if (get_field('text')) : ?>
                <div class="text fadeout_<?php the_field('disable_fade_out'); ?>  "><?php the_field('text'); ?></div>
            <?php endif; ?>
                ...
                ?>
                            <span class="svg">
                                <svg width="7" height="14" viewBox="0 0 7 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M0.146447 13.1464C-0.0488156 12.9512 -0.0488156 12.6346 0.146447 12.4393L5.44975 7.13604L0.146446 1.83274C-0.0488163 1.63748 -0.0488167 1.32089 0.146446 1.12563C0.341708 0.93037 0.65829 0.93037 0.853552 1.12563L6.86396 7.13604L0.853553 13.1464C0.658291 13.3417 0.341709 13.3417 0.146447 13.1464Z" fill="#F1D593" />
                                </svg>
                            </span>
                        <?php
                            echo '</a>';
                    ...
                    <a href="<?= $linkB['url']; ?>"><?= $linkB['title']; ?>
                        <span class="chevron">
                            <svg width="5" height="10" viewBox="0 0 5 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M0.10464 9.25523C-0.0348334 9.12005 -0.0348334 8.90088 0.10464 8.7657L3.89271 5.09418L0.104639 1.42267C-0.034834 1.28748 -0.0348342 1.06831 0.104639 0.93313C0.244112 0.797949 0.470242 0.797949 0.609715 0.93313L4.90286 5.09418L0.609716 9.25523C0.470243 9.39041 0.244113 9.39041 0.10464 9.25523Z" fill="#313131" />
                            </svg>
                        </span>
                    </a>
                </div>
