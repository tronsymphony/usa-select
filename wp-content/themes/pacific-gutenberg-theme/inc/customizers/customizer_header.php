...
function header_customizer($wp_customize)
{
  ...
  $wp_customize->add_setting('header_faq_button_title', ['default' => 'Faq']);
  $wp_customize->add_setting('header_faq_button_icon', ['default' => get_theme_url() . '/assets/images/header/faq.svg']);
  $wp_customize->add_setting('header_faq_button_link', ['default' => '/ubicaciones/']);
