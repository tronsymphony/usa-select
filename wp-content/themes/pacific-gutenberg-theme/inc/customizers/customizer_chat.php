...
function chat_customizer($wp_customize)
{
  ...
  $wp_customize->add_setting('chat_call_title', ['default' => '+507 800-1300']);
  $wp_customize->add_setting('chat_call_title_2', ['default' => '0500 226 3726']);
  $wp_customize->add_setting('chat_call_title_3', ['default' => '+507 282-2013']);
  $wp_customize->add_setting('chat_call_link', ['default' => 'tel:+123456789']);
  $wp_customize->add_setting('chat_call_link_2', ['default' => '']);
  $wp_customize->add_setting('chat_call_link_3', ['default' => '']);
